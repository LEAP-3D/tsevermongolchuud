...
export default function DashboardStats({ selectedChild, rangeUsage, safetyScore, blockedSites, timeFilter }: DashboardStatsProps) {
  const usageLabel = timeFilter === "today"
    ? "Today's Usage"
    : timeFilter === "7d"
      ? "Last 7 Days"
      : "Last 30 Days";
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="bg-white rounded-2xl p-4 md:p-6 border border-gray-200/80">
        ...
        <div className="flex items-center gap-1 pt-3 border-t border-gray-100">
          ...
          <span className="text-sm text-green-500 font-medium">Usage in selected range</span>
        </div>
      </div>

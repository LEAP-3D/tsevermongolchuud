        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            ...
            <div className="mb-3">
              ...
              <p className="text-xl md:text-2xl font-semibold text-gray-900 ml-8">3h 45m</p>
            </div>
            ...
            <div>
              ...
              <p className="text-xl md:text-2xl font-semibold text-gray-900 ml-8">2h 12m</p>
            </div>
          </div>
      ...
      <div className="bg-white rounded-2xl p-4 md:p-6 border border-gray-200/80">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-2xl md:text-3xl font-semibold text-gray-900 mb-1">87%</p>
      ...
      <div className="bg-white rounded-2xl p-4 md:p-6 border border-gray-200/80">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-2xl md:text-3xl font-semibold text-gray-900 mb-1">37</p>

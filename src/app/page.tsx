...
import type { CategorySlice, ChatMessage, Child, RiskPoint, UsagePoint } from './components/types';
...
export default function AppleStyleDashboard() {
  ...
  const sendMessage = (override?: string) => {
    ...
    const userMessage: ChatMessage = { id: Date.now(), sender: 'user', text: nextText };

    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl p-7 border border-slate-200 shadow-soft">
        ...
        <div className="space-y-4">
          <input
            ...
            className="w-full h-3 bg-linear-to-r from-accent-200 to-accent-300 rounded-full appearance-none cursor-pointer accent-accent-600"
            style={{
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-soft overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <div className="flex items-center justify-between p-5 bg-linear-to-br from-primary-50 to-primary-100/50 rounded-xl border border-primary-200">
            <div>
          ...
          <div className="flex items-center justify-between p-5 bg-linear-to-br from-secondary-50 to-secondary-100/50 rounded-xl border border-secondary-200">
            <div>
              <p className="text-base font-bold text-slate-900 mb-1">
                Weekends
              </p>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-soft overflow-hidden">
        ...
        <div className="p-6 space-y-3">
          {[
            ...
            <div
              key={idx}
              className="flex items-center justify-between p-5 bg-linear-to-br from-slate-50 to-slate-100/50 rounded-xl border border-slate-200 hover:border-slate-300 transition-all"
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 bg-linear-to-br ${app.color} rounded-xl flex items-center justify-center shadow-soft`}
                >
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  ...
                  <p className="text-xl font-bold text-slate-900">{app.time}</p>
                </div>
        ...
        <div className="p-6 bg-slate-50 border-t border-slate-200">
          <button className="w-full px-5 py-3 bg-linear-to-r from-primary-500 to-primary-600 text-white font-semibold rounded-xl hover:from-primary-600 hover:to-primary-700 transition-all shadow-soft flex items-center justify-center gap-2">

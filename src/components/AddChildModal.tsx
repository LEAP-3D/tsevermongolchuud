      ...
      <div className="bg-white rounded-3xl p-8 max-w-md w-full border border-slate-200 shadow-soft-xl animate-scale-in">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="bg-gradient-to-br from-primary-50 to-primary-100/50 rounded-xl p-5 border-2 border-primary-200">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={copyPin}
                  className="w-14 h-14 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl hover:from-primary-600 hover:to-primary-700 transition-all flex items-center justify-center shadow-soft"
                >
                  {copiedPin ? (
        ...
        <button className="w-full mt-8 bg-gradient-to-r from-primary-500 to-primary-600 text-white py-4 rounded-xl hover:from-primary-600 hover:to-primary-700 transition-all font-bold text-base shadow-soft hover:shadow-soft-lg">
          Create Account
        </button>
      </div>
    </div>

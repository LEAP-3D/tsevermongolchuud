          ...
          <div className="w-full max-w-3xl rounded-2xl bg-white shadow-2xl border border-gray-200">
            ...
            <div className="p-5 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="rounded-xl border border-gray-100 p-4 bg-gray-50">
                ...
                <p className="text-2xl font-semibold text-gray-900">{summary.total.toFixed(1)}h</p>
              </div>
              <div className="rounded-xl border border-gray-100 p-4 bg-gray-50">
                <p className="text-xs text-gray-500 mb-1">Daily Average</p>
                <p className="text-2xl font-semibold text-gray-900">{summary.avg.toFixed(1)}h</p>
              </div>
              <div className="rounded-xl border border-gray-100 p-4 bg-gray-50">
            ...
            <div className="px-5 pb-5">
              <div className="rounded-xl border border-gray-100 overflow-hidden">
                ...
                <div className="divide-y divide-gray-100">
                  {usageData.map(point => (
                    <div key={point.day} className="grid grid-cols-3 gap-0 px-4 py-3 text-sm text-gray-700">
